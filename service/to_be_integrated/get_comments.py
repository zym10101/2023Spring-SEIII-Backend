...
if __name__ == '__main__':
    pageNum = 1
    url = 'https://api.github.com/repos/apache/superset/issues/comments'
    ...
    # 记录issue链接与存放路径等
    f = open('./superset_comment.csv', 'w', encoding='utf-8')
    ...
    for issue in json_data:
        ...
        line = ','.join(
            [issue['html_url'].replace(',', ';'), body, '&'.join(labels), issue['created_at'], user, reactions])
        f.write(line)
        f.write('\n')
